...
contract('SimpleBank', function(accounts) {
  ...
  it("should deposit correct amount", async () => {
    ...
    assert.equal(deposit.toString(), balance,
  ...
  it("should withdraw correct amount", async () => {
    ...
    const expectedEventResult = {accountAddress: alice, newBalance:
      initialAmount, withdrawAmount: deposit};


    assert.equal(expectedEventResult.accountAddress, accountAddress,
      "LogWithdrawal event accountAddress property not emitted, check deposit method");
    assert.equal(expectedEventResult.newBalance, newBalance,
       "LogWithdrawal event newBalance property not emitted, check deposit method");
    assert.equal(expectedEventResult.withdrawAmount, withdrawAmount,
